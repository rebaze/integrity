...
public class DefaultHashTest {
	...
	public void equalityTest() {
		Tree sn1 = new InMemoryTreeBuilderImpl("c1").branch("d").add("Some".getBytes()).seal();
		Tree sn2 = new InMemoryTreeBuilderImpl("c1").branch("d").add("Some".getBytes()).seal();
		Tree sn3 = new InMemoryTreeBuilderImpl("c1").branch("d2").add("Other".getBytes()).seal();
	...
	public void equalityTestBeAwareThatHashesArePrimary() {
		Tree sn1 = new InMemoryTreeBuilderImpl("Here").branch("whatnow").add("Some".getBytes()).seal();
		Tree sn2 = new InMemoryTreeBuilderImpl("There").branch("d").add("Some".getBytes()).seal();
