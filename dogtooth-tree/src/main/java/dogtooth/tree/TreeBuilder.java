...
public interface TreeBuilder {
     ...
     * Only possible before {@link TreeBuilder}.seal() is called.
     *
     * @param subtree tree to be added as branch. Note that this branch of cause will be unmodifiable.
     *
     * @return An instance of {@link dogtooth.tree.StaticTreeBuilder}
     */
